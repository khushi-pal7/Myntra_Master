...
import { squadRoomsReducer, createSquadRoomReducer, squadRoomDetailsReducer, joinSquadRoomReducer, squadRoomInfoReducer, squadInviteReducer } from './Reducer/squadreducer';
...
const reducer = combineReducers({
      ...
      squadRooms: squadRoomsReducer,
      createSquadRoom: createSquadRoomReducer,
      squadRoomDetails: squadRoomDetailsReducer,
      joinSquadRoom: joinSquadRoomReducer,
      squadRoomInfo: squadRoomInfoReducer,
      squadInvite: squadInviteReducer
