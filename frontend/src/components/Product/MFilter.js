    ...
    <Fragment>
      ...
      <div className={`${sortvi} z-20 bg-[#18181846] w-full h-full fixed top-0`} onClick={() => setsortvi('hidden')}>
        <div className='absolute bottom-0 h-[45%] w-full bg-white'>
          ...
          <h1 className="text-base font1 py-3 px-6 flex justify-start items-center" onClick={() => { setsortvi('hidden'); }}><AiOutlineFire className='text-xl mr-2' />Popularity</h1>
          <h1 className="text-base font1 py-3 px-6 flex justify-start items-center" onClick={() => { datefun(1); setsortvi('hidden'); }}><AiOutlineStar className='text-xl mr-2' />Latest</h1>
      ...
      <div className={`${filter} z-20 bg-white w-full h-full fixed top-0 `}>
        <div className=''>
          ...
          <div className='grid grid-cols-12 w-full font1 bg-white py-3 border-t-[0.5px] border-slate-200 absolute bottom-0 h-[7%]'>
            ...
            onClick={() => {
              setMMainlink(MMainlink.includes('?') ? `${MMainlink}&sellingPrice[$gte]=${price[0]}&sellingPrice[$lte]=${price[1]}` : `${MMainlink}?sellingPrice[$gte]=${price[0]}&sellingPrice[$lte]=${price[1]}`);
              filterdiv();
              reloadproducts();
            }}>
              <Link to={MMainlink}>
