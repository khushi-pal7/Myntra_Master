...
export const getwishlist = (userid) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: FAIL_GET_WISHLIST, payload: error.response?.data?.message || error.message })
    }
}
...
export const getbag = (userid) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: FAIL_GET_BAG, payload: error.response?.data?.message || error.message })
    }
}
...
export const getqtyupdate = (qtydata) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: FAIL_UPDATE_QTY_BAG, payload: error.response?.data?.message || error.message })
    }
}
